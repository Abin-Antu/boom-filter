...
bloom = create_bloom_filter(size)
add_to_bloom_filter(bloom, "book_123", size, hash_count)

print(check_bloom_filter(bloom, "book_123"))  # True
print(check_bloom_filter(bloom, "book_xyz"))  # False or maybe True
